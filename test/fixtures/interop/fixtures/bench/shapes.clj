...
;; a new edition ships.
(ns interop.fixtures.bench.shapes
...
;; ---------------------------------------------------------------
;; messages
(declare Flat->proto Tiny->proto Deep->proto Level2->proto Level3->proto Level4->proto WideRepeated->proto RepeatedMessages->proto MapHeavy->proto EnumHeavy->proto Reply->proto Payload->proto Item->proto proto->Tiny--map proto->Level2--map proto->Level3--map proto->Level4--map proto->Payload--map proto->Item--map proto->Tiny--slot-map proto->Level2--slot-map proto->Level3--slot-map proto->Level4--slot-map proto->Payload--slot-map proto->Item--slot-map)
;;
...
(defn proto->EnumHeavy
  ...
  ([^com.google.protobuf.Message msg opts]
   (cond
     (and (nil? opts) (instance? com.acme.fixtures.bench.EnumHeavy msg))
     (let [^com.acme.fixtures.bench.EnumHeavy m msg]
       (->EnumHeavy
        (when (.hasId m) (.getId m))
        (when (.hasS1 m) (case (.getS1Value m) 0 :STATUS_UNSPECIFIED 1 :STATUS_ACTIVE 2 :STATUS_PAUSED 3 :STATUS_CLOSED (codec/get-field m EnumHeavy--s1 nil)))
        (when (.hasS2 m) (case (.getS2Value m) 0 :STATUS_UNSPECIFIED 1 :STATUS_ACTIVE 2 :STATUS_PAUSED 3 :STATUS_CLOSED (codec/get-field m EnumHeavy--s2 nil)))
        (when (.hasS3 m) (case (.getS3Value m) 0 :STATUS_UNSPECIFIED 1 :STATUS_ACTIVE 2 :STATUS_PAUSED 3 :STATUS_CLOSED (codec/get-field m EnumHeavy--s3 nil)))
        (when (.hasS4 m) (case (.getS4Value m) 0 :STATUS_UNSPECIFIED 1 :STATUS_ACTIVE 2 :STATUS_PAUSED 3 :STATUS_CLOSED (codec/get-field m EnumHeavy--s4 nil)))
        (when (.hasS5 m) (case (.getS5Value m) 0 :STATUS_UNSPECIFIED 1 :STATUS_ACTIVE 2 :STATUS_PAUSED 3 :STATUS_CLOSED (codec/get-field m EnumHeavy--s5 nil)))
        (when (.hasS6 m) (case (.getS6Value m) 0 :STATUS_UNSPECIFIED 1 :STATUS_ACTIVE 2 :STATUS_PAUSED 3 :STATUS_CLOSED (codec/get-field m EnumHeavy--s6 nil)))
        (when (.hasS7 m) (case (.getS7Value m) 0 :STATUS_UNSPECIFIED 1 :STATUS_ACTIVE 2 :STATUS_PAUSED 3 :STATUS_CLOSED (codec/get-field m EnumHeavy--s7 nil)))
        (when (.hasS8 m) (case (.getS8Value m) 0 :STATUS_UNSPECIFIED 1 :STATUS_ACTIVE 2 :STATUS_PAUSED 3 :STATUS_CLOSED (codec/get-field m EnumHeavy--s8 nil)))
        (codec/get-field m EnumHeavy--history nil)
        ))
...
(defn Reply->proto
  ...
  ([m opts]
   (if (nil? opts)
     (let [b (com.acme.fixtures.bench.Reply/newBuilder)]
       (when-some [v (:name m)] (.setName b ^String v))
       (when-some [v (:payload m)] (if (map? v) (.setPayload b ^com.acme.fixtures.bench.Payload (Payload->proto v nil)) (codec/set-field! b Reply--payload v nil)))
       (.build b))
...
(defn proto->Reply
  ...
  ([^com.google.protobuf.Message msg opts]
   (cond
     (and (nil? opts) (instance? com.acme.fixtures.bench.Reply msg))
     (let [^com.acme.fixtures.bench.Reply m msg]
       (->Reply
...
(defn Payload->proto
  ...
  ([m opts]
   (if (nil? opts)
     (let [b (com.acme.fixtures.bench.Payload/newBuilder)]
       (when-some [v (:id m)] (.setId b ^String v))
...
(defn proto->Payload
  ...
  ([^com.google.protobuf.Message msg opts]
   (cond
     (and (nil? opts) (instance? com.acme.fixtures.bench.Payload msg))
     (let [^com.acme.fixtures.bench.Payload m msg]
       (->Payload
        (when (.hasId m) (.getId m))
...
(defn- proto->Payload--map
  ...
  the same values, minus the keys the codec's read leaves out."
  [^com.acme.fixtures.bench.Payload m]
  (let [id--v (when (.hasId m) (.getId m))
...
(defn Item->proto
  ...
  ([m opts]
   (if (nil? opts)
     (let [b (com.acme.fixtures.bench.Item/newBuilder)]
...
(defn proto->Item
  ...
  ([^com.google.protobuf.Message msg opts]
   (cond
     (and (nil? opts) (instance? com.acme.fixtures.bench.Item msg))
     (let [^com.acme.fixtures.bench.Item m msg]
       (->Item
...
(defn- proto->Item--map
  ...
  the same values, minus the keys the codec's read leaves out."
  [^com.acme.fixtures.bench.Item m]
